...
fn main() {
    ...
    book.submit(Order::new_limit(1, "BTCUSD", Side::Sell, 50_000, 2)).unwrap();
    book.submit(Order::new_limit(2, "BTCUSD", Side::Sell, 50_010, 3)).unwrap();
    book.submit(Order::new_limit(3, "BTCUSD", Side::Sell, 50_025, 10)).unwrap();
